                        ...
                        <tr>
                          ...
                          <td align="center" style="font-size: 0; " width="468">
                            <a href="https://blockcluster.io/" target="_blank" conversion="true" alias="">
                              <img src="https://s3-us-west-2.amazonaws.com/bc-email-t-images/email.jpg" width="468" style="margin:0 auto;display: block; max-width: 468px; width: 468px;" bgcolor="#ffffff" border="0" alt="">
                            </a>
                          </td>
                          <td align="center" valign="top" style="font-size: 0; ">
                            <table width="66" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile-hidden" bgcolor="#fff">
                        ...
                        <tr>
                          <td align="center" style="font-size: 0;">
                            <p style="margin: 20px 15px 16px 15px;font-family: arial, sans-serif; font-size: 22px; color: #4d4d4d;">
                              <strong>Verify Your Email<br><span style="color: #00adef">BlockCluster Family Welcomes You</span></strong>
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size: 0;padding:0 75px 15px 75px;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                        <tbody><tr>
                                          <td width="250" height="50" align="center" bgcolor="#0062b3" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="<%= verificationLink %>" target="_blank" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff" class="button_link">
                                            Verify Email
                                             <img src="https://s3-us-west-2.amazonaws.com/bc-email-t-images/right-arrow.png" width="32" height="17" style="padding-top:5px" alt="" border="0"></a></td>
                                        </tr>
                                      </tbody></table>
                              <div width="200;height:20px;"></div>
                              <p style="line-height:22px;font-family: arial, sans-serif; font-size: 15px; color: #4d4d4d;">or copy the URL in browser. <%= verificationLink %> in your browser</p>
                          </td>
                        </tr>
                        <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mobile-hidden">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="text-footer" style="color:#b7b5b5; font-family:Arial; font-size:14px; line-height:22px; text-align:center">
                                <a href="https://blockcluster.io/" class="link-footer" style="color:#605f5d; text-decoration:none" target="_blank">
                                    <span class="link-footer" style="color:#605f5d; text-decoration:none">Blockcluster</span></a>                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <a href="https://www.blockcluster.io/pricing" class="link-footer" style="color:#605f5d; text-decoration:none" target="_blank">
                                <span class="link-footer" style="color:#605f5d; text-decoration:none">Pricing</span></a>                            <span class="mobile-block"><span class="hide-for-mobile">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span>  <a href="https://www.blockcluster.io/terms" class="link-footer" style="color:#605f5d; text-decoration:none" target="_blank"><span class="link-footer" style="color:#605f5d; text-decoration:none">T&amp;Cs</span></a></div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                              <tbody>
                                <tr>
