...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Verify Payment Method</title>
    <style type="text/css">
                        ...
                        <tr>
                          <td align="center" style="font-size: 0;padding:0 75px 15px 75px;">
                            <p style="line-height:22px;font-family: arial, sans-serif; font-size: 13px; color: #4d4d4d;">
                              <span style="color:#999;font-size: 17px;font-family: &#39;arial&#39;;line-height: 24px;text-align: center;">Hi,  <span style="color: #09759c;font-weight: bold;"><%= user.name %></span> Hope you are enjoying the blockcluster platform. We have noticed that you haven't used your nodes in last few days. Kindly verify your credit card on the platform to continue using your nodes.<br><br></span>
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                              ...
                              <div width="200;height:20px;"></div>
                              <p style="line-height:22px;font-family: arial, sans-serif; font-size: 15px; color: #4d4d4d;">or copy the URL in browser. https://app.blockcluster.io/app/payments in your browser</p>
                          </td>
                        </tr>
                        <tr>
