                      ...
                      <tr>
                        ...
                        <td align="center" style="font-size: 0; " width="468">
                          <a href="https://blockcluster.io/" target="_blank" conversion="true" alias="">
                            <img src="https://s3-us-west-2.amazonaws.com/bc-email-t-images/notif.jpg" width="468" style="margin:0 auto;display: block; max-width: 468px; width: 468px;" bgcolor="#ffffff" border="0" alt="">
                          </a>
                        </td>
                        <td align="center" valign="top" style="font-size: 0; ">
                          <table width="66" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile-hidden" bgcolor="#fff">
                      ...
                      <tr>
                        <td align="center" style="font-size: 0;padding:0 75px 15px 75px;">
                          <p style="line-height:22px;font-family: arial, sans-serif; font-size: 13px; color: #4d4d4d;">
                            <span style="color:#999;font-size: 17px;font-family: &#39;arial&#39;;line-height: 24px;text-align: center;">Hi, <span style="color: #333;"> <%= user.name %></span>, it seems you forgot your password,No Issues, we have  got your back. Just click on the button below to reset your password</span>
                          </p>
                          ...
                          <table border="0" align="center" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                              <tbody>
                                <tr>
                                  <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                      <tbody><tr>
                                        <td width="250" height="50" align="center" bgcolor="#0062b3" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="<%= resetPasswordLink %>" target="_blank" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff" class="button_link">Reset Password</a></td>
                                      </tr>
                                    </tbody></table></td>
                                </tr>
                              </tbody>
                            ...
                            <div width="200;height:20px;"></div>
                            <p style="line-height:22px;font-family: arial, sans-serif; font-size: 15px; color: #4d4d4d;">or copy the URL in browser. <b><%= resetPasswordLink %></b> in your browser</p>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="text-footer2" style="color:#605f5d; font-family:Arial; font-size:12px; line-height:20px; text-align:center">
                            ...
                            <!-- <br>You can unsubscribe from these emails <a href="#" class="link-footer" style="color:#605f5d; text-decoration:none" target="_blank"><strong class="link-footer" style="color:#605f5d; text-decoration:none">here</strong></a> (Don't worry, we won't take it personally). -->
