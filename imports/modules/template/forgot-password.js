...
<title>Reset password at Blockcluster.io</title>
<style type="text/css">
  html,
  body,
  p,
...
<body>
  ...
  <div style="background: #f0f0f0; width: 80%; margin: auto; padding: 20px;">
    ...
    <h2 style="margin-bottom: 5px;">Reset Password</h2>

    <h4 style="margin-bottom: 0px">Hi
        <%= user.name %>,</h4>
    <p style="margin-top: 5px;">
        It seems like you forgot your password. No issues, we got your back. Just click on the button below to reset your password
        <br />
        <br />
        <a href="<%= resetPasswordLink %>" target="_blank" style="background: #48b0f7;
          border-color: #48b0f7;
          color: #fff;
          line-height: 21px;
          cursor: pointer;
        ...
        <br />
        <br />
        Or copy the following URL in your browser. <a href="<%= resetPasswordLink %>" target="_blank"><%= resetPasswordLink %></a>
    </p>
