                    ...
                    <tr>
                      ...
                      <td align="center" style="font-size: 0; " width="468">
                        <a href="https://blockcluster.io/" target="_blank" conversion="true" alias="">
                          <img src="https://s3-us-west-2.amazonaws.com/bc-email-t-images/card.jpg" width="468" style="margin:0 auto;display: block; max-width: 468px; width: 468px;" bgcolor="#ffffff" border="0" alt="">
                        </a>
                      </td>
                      <td align="center" valign="top" style="font-size: 0; ">
                        <table width="66" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile-hidden" bgcolor="#fff">
                    ...
                    <tr>
                      <td align="center" style="font-size: 0;">
                        <p style="margin: 20px 15px 16px 15px;font-family: arial, sans-serif; font-size: 22px; color: #4d4d4d;">
                          <strong>Bill generated for                               <br><span style="color: #00adef"><%= invoice.billingPeriodLabel %></span></strong>
                        </p>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" style="font-size: 0;padding:0 75px 15px 75px;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                          ...
                          <div width="200;height:20px;"></div>
                          <p style="line-height:22px;font-family: arial, sans-serif; font-size: 15px; color: #4d4d4d;">or copy the URL in browser. <%- paymentLink %> in your browser.</p>
                          <p style="line-height:22px;font-family: arial, sans-serif; font-size: 13px; color: #4d4d4d;">
                            Kindly pay your bill before 10th of this month to avoid deletion of nodes.
                            Incase you have chose auto-debit option, the amount will be auto debited on 5th of this month and you can ignore this email.
                          </p>
                      </td>
                    </tr>
                    <tr>
