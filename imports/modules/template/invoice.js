          ...
          <div class="invoice padding-50 sm-padding-10">
            <div>
              <div class="pull-left">
                <img
                  ...
                  class="invoice-logo"
                  crossorigin="*"
                  src="https://s3-us-west-2.amazonaws.com/bc-email-t-images/block_cluster_logo.png"
                />
                <address class="m-t-10">
                  Byzantine Technologies Pvt Ltd. <br />CIN :  U7200DL2018PTC331594 <br />
            ...
            <div class="col-12">
              <div class="row">
                <div class="col-lg-9 col-sm-height sm-no-padding">
                  ...
                  <address>
                    <!-- <strong>Pages Incoperated.</strong> <br />page.inc <br />
                    1600 Amphitheatre Pkwy, Mountain View,<br />
                    CA 94043, United States -->
                    TEL: <%= user.profile.mobiles[0].number %>
                  </address>
                </div>
                <div
            ...
            <div class="p-l-15 p-r-15">
              <div class="row b-a b-grey">
                <div
                  class="col-md-7 p-l-15 sm-p-t-15 clearfix sm-p-b-15 d-flex flex-column justify-content-center"
                >
                ...
                <!-- <div
                  class="col-md-5 clearfix sm-p-b-15 d-flex flex-column justify-content-center"
                >
                  <h5
                    class="font-montserrat all-caps small no-margin hint-text bold"
                  >
                ...
                <div
                  class="col-md-5 text-right bg-master-darker col-sm-height padding-15 d-flex flex-column justify-content-center align-items-end"
                >
                  <h5
                  ...
                  <h1 class="no-margin text-white"><%= invoice.totalAmount %></h1>
                </div>
              </div>
            </div>
            <br />
            <br />
            <div style="text-align:right"><p>Byzantine Technologies Pvt Ltd
            </p>
              <img
                width="150"
                height="58"
