                        ...
                        <tr>
                          ...
                          <td align="center" style="font-size: 0; " width="468">
                            <a href="https://blockcluster.io/" target="_blank" conversion="true" alias="">
                              <img src="https://s3-us-west-2.amazonaws.com/bc-email-t-images/support_update.jpg" width="468" style="margin:0 auto;display: block; max-width: 468px; width: 468px;" bgcolor="#ffffff" border="0" alt="">
                            </a>
                          </td>
                          <td align="center" valign="top" style="font-size: 0; ">
                            <table width="66" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile-hidden" bgcolor="#fff">
                        ...
                        <tr>
                          <td align="center" style="font-size: 0;">
                            <p style="margin: 20px 15px 16px 15px;font-family: arial, sans-serif; font-size: 22px; color: #4d4d4d;">
                              <strong>Update on your support case! <br><span style="color: #00adef"><a href="https://dev.blockcluster.io/app/support/<%= support.caseId %>">#<%= support.caseId %> </a></span></strong>
                            </p>
                          </td>
                        </tr>
                        <tr>
