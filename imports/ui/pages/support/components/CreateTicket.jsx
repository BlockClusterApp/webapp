...
class CreateTicket extends React.Component {
  ...
  render() {
    const name =
      this.props.user && this.props.user.profile ? `${this.props.user.profile.firstName} ${this.props.user.profile.lastName} <${this.props.user.emails[0].address}>` : null;
    const networks =
      this.props.networks &&
      this.props.networks.map(network => {
        return (
          <option value={network._id} key={network.instanceId}>
    ...
    return (
      <div className="row padding-25 createTicket">
        <div className="card card-transparent">
          ...
          {this.state.regarding === 'technical' && (
            <div className="row">
              <div className="col-md-6">
                ...
                >
                  ...
                  <option value="paymeter">Paymeter</option>
          ...
          <div className="row">
            <div className="col-md-4">
              <LaddaButton
                ...
                type="submit"
              >
                <i className="fa fa-plus-circle" aria-hidden="true" />&nbsp;&nbsp;Submit
              </LaddaButton>
            </div>
          </div>
        </div>
