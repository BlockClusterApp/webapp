                              ...
                              <div className="widget-9 card no-border bg-warning no-margin widget-loader-bar">
                                <div className="full-height d-flex flex-column">
                                  ...
                                  <div className="p-l-20">
                                    <h3 className="no-margin p-b-30 text-white ">
                                      {this.props.hyperion.length === 1 &&
                                        <span>${helpers.getFlooredFixed(((((this.props.hyperion[0].size / 1024) / 1024) / 1024) * (helpers.hyperionGBCostPerDay() * helpers.daysInThisMonth())).toPrecision(2), 2)}</span>
                                      }
                              ...
                              <div className="widget-9 card no-border bg-complete no-margin widget-loader-bar">
                                <div className="full-height d-flex flex-column">
                                  ...
                                  <div className="p-l-20">
                                    <h3 className="no-margin p-b-30 text-white ">
                                      {this.props.hyperion.length === 1 &&
                                        <span>${helpers.getFlooredFixed(((((((this.props.hyperion[0].size / 1024) / 1024) / 1024) * (helpers.hyperionGBCostPerDay() * helpers.daysInThisMonth())).toPrecision(2)) - this.props.hyperion[0].discount).toPrecision(2), 2)}</span>
                                      }
                              ...
                              <div className="row row-same-height">
                                <div className="col-md-6 sm-b-b b-r b-dashed b-grey ">
                                  <div className="padding-30 sm-padding-5 sm-m-t-15">
                                    ...
                                    <p className="small hint-text">Note that anyone with the hash of the file can download the file from any geo-graphic location. The hash should be shared only with parties which should have access to it.</p>
                                    <div>
                                      <div>
                                      {this.props.hyperion.length === 1 ? (
                                        <div>
                                  ...
                                  <div className="row">
                                    <div className="col-lg-12">
                                      ...
                                      <p className="small hint-text">
                                        We only charge for uploading files. There are no charges for bandwidth utilization. We deduct the fees from your added debit/credit card at the end of the month.
                                      </p>
                                    </div>
                                  </div>
                                  <div className="row">
                                    <div className="col-lg-12">
                                      ...
                                      <p className="small hint-text">
                                        We charge $399 or total storage fees consumed depending on whichever is greater
                                      </p>
                                    </div>
                                  </div>
