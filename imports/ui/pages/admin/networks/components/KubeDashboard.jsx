      ...
      <div className="full-width">
        <div className="row" style={{ paddingLeft: '25px', paddingRight: '25px' }}>
          <div className="col-md-6 d-flex flex-column">
            ...
            <p>
              <span className="label-custom no-margin">Namespace:</span> {deployments.namespace}
            </p>
            <p>
              <span className="label-custom no-margin">Created At:</span> {deployments.createdAt}
            </p>
            <p>
              <span className="label-custom no-margin">Replicas:</span> {deployments.status.readyReplicas}/{deployments.status.replicas}
            </p>
          </div>
          <div className="col-md-6 d-flex flex-column">
            <h6>Strategy</h6>
            <p>
              <span className="label-custom no-margin">Type:</span> {deployments.strategy.type}
            </p>
          </div>
        </div>
      </div>
