...
class NetworkList extends Component {
  ...
  search = () => {
    this.networkSubscription = Meteor.subscribe("networks.search", {
      query: this.query
    }, {
      onReady: () => {
        this.setState({
  ...
  changePage = (pageOffset) => {
    ...
    this.networkSubscription.stop();
    this.networkSubscription =  Meteor.subscribe("networks.all", {query: this.query, page: this.state.page + pageOffset}, {
      onReady: () => {
  ...
  getEmailVerificationLabel = (verification) => {
    ...
    const locationOptions = this.state.locations.map(location => {
      return <option value={location.locationCode} key={location.locationCode}>{location.locationName}</option>
    })
		return (
                        ...
                        <div className="col-lg-12">
                            <div className="card card-transparent">
                                <div className="card-header ">
                                    <div className="card-title">Networks
                                    </div>
                                </div>
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-md-2">
                                      <div className="checkbox check-success">
                                        <input type="checkbox" value="1" defaultChecked="checked" id="checkbox2" onClick={(e) => {
                                          if(e.target.checked) {
...
export default withTracker(() => {
    return {
      subscriptions: [
        Meteor.subscribe("networks.all", {page: 0})
      ]
    }
