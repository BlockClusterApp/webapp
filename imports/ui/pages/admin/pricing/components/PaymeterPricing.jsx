                ...
                <div className="card-block">
                  <div className="row" style={{ marginTop: '10px' }}>
                    <div className="col-md-12">
                      ...
                      <input type="number" className="form-control" placeholder="$" defaultValue={paymeter.minimumMonthlyCost} ref={input => (this.minimumMonthly = input)} />
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12" style={{ marginTop: '10px' }}>
                      <i className="fa fa-joomla" />
                      &nbsp;Per API Cost &nbsp;($)
                      <input type="number" className="form-control" placeholder="$" defaultValue={paymeter.perApiCost} ref={input => (this.perApiCost = input)} />
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12" style={{ marginTop: '10px' }}>
                      <i className="fa fa-joomla" />
                      &nbsp;Per wallet cost&nbsp;($)
                      <input type="number" className="form-control" placeholder="$" defaultValue={paymeter.perWalletCost} ref={input => (this.perWalletCost = input)} />
                    </div>
                  </div>
