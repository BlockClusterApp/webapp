              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="card-title">
                    <h3>PrivateHive Network Voucher</h3>
                  </div>
                </div>
              </div>
...
export default withTracker(() => {
  return {
    ...
    subscriptions: [Meteor.subscribe('vouchers.all', { page: 0 }), Meteor.subscribe('networkConfig.privatehive'), Meteor.subscribe('campaign.all')],
  };
