                      ...
                      <div className="card card-transparent">
                        ...
                        <div className="card-block">
                          ...
                          <pre>
                            ...
                            {'"https://' +
                              this.props.workerNodeDomainName(this.props.network[0] ? this.props.network[0].locationCode : '') +
                              '/api/node/' +
                              (this.props.network[0] ? this.props.network[0].instanceId : '') +
                              '/jsonrpc' +
                              '", 0, ' +
                              '"username", "password"'}
                            ) );
                                  ...
                                  <div className="form-group form-group-default required">
                                    ...
                                    {this.props.network.length === 1 && (
                                      <input
                                        ...
                                        readOnly
                                        value={this.props.network[0].instanceId}
                                      />
                                    )}
                                  </div>
                                </div>
                                  ...
                                  <div className="form-group form-group-default required">
                                    ...
                                    {this.props.network.length === 1 && (
                                      <input
                                        ...
                                        name="password"
                                        placeholder={this.props.network[0].instanceId}
                                      />
                                    )}
                                  </div>
                                </div>
