...
class JoinNetwork extends Component {
  ...
  onJoinSubmit = e => {
    ...
    reader.onload = evt => {
      ...
      Meteor.call(
        ...
        this.nodeType.value,
        fileContent,
        this.state.totalENodes,
        this.state.impulseURL,
        this.assetsContractAddress.value,
        this.atomicSwapContractAddress.value,
        this.streamsContractAddress.value,
        this.impulseContractAddress,
        this.locationCode,
        { ...this.config },
        error => {
          if (!error) {
  ...
  onInviteSubmit = e => {
    ...
    Meteor.call('inviteUserToNetwork', { instanceId: this.networkNameInvite.value, nodeType: this.nodeTypeInvite.value, email: this.email.value }, error => {
      if (!error) {
        this.setState({
          inviteFormSubmitError: '',
          inviteLoading: false,
            ...
            <div className="card card-borderless card-transparent">
              <ul className="nav nav-tabs nav-tabs-linetriangle" role="tablist" data-init-reponsive-tabs="dropdownfx">
                <li className="nav-item">
                  <a className="active" data-toggle="tab" role="tab" data-target="#join" href="#">
                    Manually Join Network
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#" data-toggle="tab" role="tab" data-target="#invite">
                    ...
                    <div className="col-lg-5">
                      <div className="card card-transparent">
                        <div className="card-header ">
                          <div className="card-title">Join Network</div>
                        </div>
                        <div className="card-block">
                          <h3>Join a Existing Blockchain Network</h3>
                      ...
                      <div className="card card-transparent">
                        <div className="card-block">
                              ...
                              <div className="col-md-6">
                                <div className="form-group form-group-default ">
                                  ...
                                  <input
                                    ...
                                    required
                                    ref={input => {
                                      this.assetsContractAddress = input;
                                    }}
                                    placeholder="0x...."
                                  />
                                </div>
                              ...
                              <div className="col-md-6">
                                <div className="form-group form-group-default ">
                                  ...
                                  <input
                                    ...
                                    required
                                    ref={input => {
                                      this.atomicSwapContractAddress = input;
                                    }}
                                    placeholder="0x...."
                                  />
                                </div>
                              ...
                              <div className="col-md-6">
                                <div className="form-group form-group-default ">
                                  ...
                                  <input
                                    ...
                                    required
                                    ref={input => {
                                      this.streamsContractAddress = input;
                                    }}
                                    placeholder="0x...."
                                  />
                                </div>
                              ...
                              <div className="col-md-6">
                                <div className="form-group form-group-default ">
                                  ...
                                  <input
                                    ...
                                    required
                                    ref={input => {
                                      this.impulseContractAddress = input;
                                    }}
                                    placeholder="0x...."
                                  />
                                </div>
                              ...
                              <div className="col-md-12">
                                <div className="form-group form-group-default ">
                                  ...
                                  <input
                                    ...
                                    required
                                    ref={input => {
                                      this.impulseURL = input;
                                    }}
                                    placeholder="http://76.45.122.34:3478"
                                  />
                                </div>
                              </div>
                            </div>
                              ...
                              return (
                                <div className="row">
                                        ...
                                        <div className="form-group form-group-default input-group">
                                          <div className="form-input-group">
                                            ...
                                            <input
                                              ...
                                              onChange={event => {
                                                this.onENodeChange(index, event);
                                              }}
                                              value={item}
                                            />
                                          </div>
                                          <div
                                            className="input-group-addon delete-button"
                                            onClick={() => {
                                              this.deleteENodeURL(index);
                                            }}
                                          >
                                  ...
                                  <div className="col-md-12 clearfix">
                                    <button className="btn btn-complete btn-xs m-t-10 pull-right add-url" onClick={this.addENodeURL}>
                          ...
                          <LaddaButton
                            ...
                            type="submit"
                          >
                            <i className="fa fa-plus-circle" aria-hidden="true" />&nbsp;&nbsp;Join
                          </LaddaButton>
                        </div>
                      </div>
                    </div>
                ...
                <div className="tab-pane " id="invite">
                  <div className="row">
                    <div className="col-lg-5">
                      <div className="card card-transparent">
                        <div className="card-header ">
                          <div className="card-title">Invite to Network</div>
                        </div>
                        <div className="card-block">
                          <h3>Invite an user on the platform to join your network</h3>
                        ...
                        <div className="card-block">
                          <form id="form-project" role="form" onSubmit={this.onInviteSubmit} autoComplete="off">
                            ...
                            <LaddaButton
                              ...
                              type="submit"
                            >
                              <i className="fa fa-plus-circle" aria-hidden="true" />&nbsp;&nbsp;Invite
                            </LaddaButton>
                          </form>
                        </div>
                      </div>
