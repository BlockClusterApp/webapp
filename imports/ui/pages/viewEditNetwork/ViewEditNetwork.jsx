                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-md-9">
                      <span className="value-valign-middle">
                        {this.props.network.length === 1 && <EditableText value={this.props.network[0].name} valueChanged={this.nodeNameChange} />}
                      </span>
                    </div>
                  </div>
                  <div className="form-group row">
                        ...
                        {this.props.network.length === 1
                          ? ReactHtmlParser(
                              helpers.convertStatusToTag(
                                helpers.calculateNodeStatus(this.props.network[0].status),
                                helpers.firstLetterCapital(helpers.calculateNodeStatus(this.props.network[0].status))
                              )
                            )
                          : ''}
                      </b>
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-md-9">
                      <span className="value-valign-middle-status">
                        {this.props.network.length === 1 ? parseFloat(this.props.network[0].networkConfig.cpu) / 1000 + ' vCPU' : ''},{' '}
                        {this.props.network.length === 1 ? parseFloat(this.props.network[0].networkConfig.ram) + ' GB RAM' : ''},{' '}
                        {this.props.network.length === 1 ? parseFloat(this.props.network[0].networkConfig.disk) + ' GB Disk' : ''}
                      </span>
                    </div>
                  </div>
                  <div className="form-group row">
                        ...
                        {(() => {
                          if (this.props.network.length === 1) {
                            if ('nodeId' in this.props.network[0]) {
                              return 'enode://' + this.props.network[0].nodeId + '@' + this.locationConfig.workerNodeIP + ':' + this.props.network[0].ethNodePort;
                            }
                          }
                        })()}
                      </b>
                              ...
                              <form className="row form-horizontal">
                                <div className="col-md-6">
                                  <input
                                    ...
                                    required
                                    placeholder="Authority Identity Address"
                                    ref={input => {
                                      this.authorityAddress = input;
                                    }}
                                  />
                                </div>
                                <div className="col-md-6">
                        ...
                        {(() => {
                          if (this.props.network.length === 1) {
                            if (typeof this.props.network[0].assetsContractAddress === undefined) {
                              ...
                              return this.props.network[0].assetsContractAddress;
                            } else {
                              return 'Not Found';
                            }
                          }
                        ...
                        {(() => {
                          if (this.props.network.length === 1) {
                            if (typeof this.props.network[0].atomicSwapContractAddress === undefined) {
                              ...
                              return this.props.network[0].atomicSwapContractAddress;
                            } else {
                              return 'Not Found';
                            }
                          }
                        ...
                        {(() => {
                          if (this.props.network.length === 1) {
                            if (typeof this.props.network[0].streamsContractAddress === undefined) {
                              ...
                              return this.props.network[0].streamsContractAddress;
                            } else {
                              return 'Not Found';
                            }
                          }
