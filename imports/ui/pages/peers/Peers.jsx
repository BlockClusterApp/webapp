                        ...
                        Meteor.call("convertIP_Location", ips, (error, result) => {
                            if(!error && result) {
                                ...
                                result.forEach((location) => {
                                    markers.push({markerOffset: 4, coordinates: location.ll.reverse(), name: result.reduce((n, obj) => {
                                                            ...
                                                            <div>
                                                                ...
                                                                <ul className="nav nav-tabs nav-tabs-fillup" data-init-reponsive-tabs="dropdownfx">
                                                                    <li className="nav-item">
                                                                        <a href="#" className="active" data-toggle="tab" data-target={"#" + this.props.network[0].instanceId + "_slide1"}><span>Add or Whitelist peers</span></a>
                                                                    </li>
                                                                    <li className="nav-item">
                                                                            ...
                                                                            <div className="col-lg-12">
                                                                                <form role="form">
                                                                                    ...
                                                                                    <p className="pull-left">
                                                                                        <LaddaButton
                                                                                            loading={this.state[this.props.network[0].instanceId + "_addPeer_formloading"]}
                                                                                            data-size={S}
                                                                                            data-style={SLIDE_UP}
                                                                                        ...
                                                                                        >
                                                                                            <i className="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Add Static Peer
                                                                                        </LaddaButton>

                                                                                        &nbsp;

                                                                                        <LaddaButton
                                                                                            loading={this.state[this.props.network[0].instanceId + "_whitelist_formloading"]}
                                                                                            data-size={S}
                                                                                            data-style={SLIDE_UP}
                                                                                            data-spinner-size={30}
                                                                                            data-spinner-lines={12}
                                                                                            ...
                                                                                            type="submit"
                                                                                            onClick={(e) => {
                                                                                                this.whitelistPeer(e, this.props.network[0].instanceId);
                                                                                            }}
                                                                                        >
                                                                                            <i className="fa fa-check" aria-hidden="true"></i>&nbsp;&nbsp;Whitelist
                                                                                        </LaddaButton>
                                                                                    </p>
                                                                                </form>
                                                                            </div>
                                                                                    ...
                                                                                    <table className="table table-hover" id="basicTable">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                ...
                                                                                                <th style={{width: "50%"}}>Peer URI</th>
                                                                                            </tr>
                                                                                        </thead>
                                                                                        <tbody>
                                                                                            {
                                                                                                this.state.staticPeers.map((item, index) => {
                                                                                                    return (
                                                                                                        <tr key={item}>
                                                                                                            <td className="v-align-middle ">
                                                                                                                <i className="fa fa-trash" onClick={(e) => {
                                                                                                                    this.removePeer(e, this.props.network[0].instanceId, item);
                                                                                                                }}></i>
                                                                                                            </td>
                                                                                                            <td className="v-align-middle">
                                                                                                                {item}
                                                                            ...
                                                                            <div className="col-lg-12">
                                                                                ...
                                                                                <div className="table-responsive">
                                                                                    <table className="table table-hover" id="basicTable">
                                                                                        ...
                                                                                        <tbody>
                                                                                            {
                                                                                                this.state.whitelistedNodes.map((item, index) => {
                                                                                                    return (
                                                                                                        <tr key={item}>
                                                                                                            <td className="v-align-middle " onClick={(e) => {
                                                                                                                this.blacklistPeer(e, this.props.network[0].instanceId, item);
                                                                                                            }}>
