			...
			<div className="login-wrapper">
	            ...
	            <div className="login-container bg-white">
	                <div className="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
	                    <img src="assets/img/logo/purple_left_img.png" alt="logo" height="55" />
	                    ...
	                    <form id="form-login" className="p-t-15" role="form" onSubmit={this.login}>
	                        ...
	                        <button className="btn btn-primary btn-cons m-t-10" type="submit"><i className="fa fa-sign-in" aria-hidden="true"></i>&nbsp;&nbsp;Sign in</button>
	                    </form>
	                    <div className="pull-bottom sm-pull-bottom">
	                        <div className="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
	                            <div className="col-sm-3 col-md-2 no-padding">
	                                <img alt="" className="m-t-5" data-src="assets/img/demo/pages_icon.png" data-src-retina="assets/img/demo/pages_icon_2x.png" height="60" src="assets/img/demo/pages_icon.png" width="60" />
	                            </div>
