...
class Explorer extends Component {
    constructor() {
        ...
        abiDecoder.addABI([{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"units","type":"int256"},{"name":"to","type":"address"}],"name":"issueBulkAsset","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"reissuable","type":"bool"}],"name":"createBulkAssetType","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"orderId","type":"string"}],"name":"getOrderInfo","outputs":[{"name":"toType","type":"string"},{"name":"fromType","type":"string"},{"name":"toId","type":"string"},{"name":"fromId","type":"string"},{"name":"fromUnits","type":"int256"},{"name":"toUnits","type":"int256"},{"name":"fromUniqueIdentifier","type":"string"},{"name":"toUniqueIdentifier","type":"string"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"uniqueAssetIdentifier","type":"string"}],"name":"isSoloAssetClosed","outputs":[{"name":"isClosed","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"}],"name":"createSoloAssetType","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"from","type":"address"}],"name":"getBulkAssetUnits","outputs":[{"name":"units","type":"int256"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"to","type":"address"},{"name":"uniqueAssetIdentifier","type":"string"}],"name":"issueSoloAsset","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"}],"name":"getSoloAssetTypeIssuer","outputs":[{"name":"issuer","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"uniqueAssetIdentifier","type":"string"},{"name":"key","type":"string"}],"name":"getSoloAssetExtraData","outputs":[{"name":"value","type":"string"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"orderId","type":"string"}],"name":"fulfillOrder","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"uniqueAssetIdentifier","type":"string"},{"name":"to","type":"address"}],"name":"transferOwnershipOfSoloAsset","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"uniqueAssetIdentifier","type":"string"}],"name":"getSoloAssetOwner","outputs":[{"name":"owner","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"uniqueAssetIdentifier","type":"string"}],"name":"closeSoloAsset","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"uniqueAssetIdentifier","type":"string"},{"name":"key","type":"string"},{"name":"value","type":"string"}],"name":"addOrUpdateSoloAssetExtraData","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"}],"name":"getBulkAssetTypeIssuer","outputs":[{"name":"issuer","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"assetName","type":"string"},{"name":"to","type":"address"},{"name":"units","type":"int256"}],"name":"transferBulkAssetUnits","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"orderId","type":"string"}],"name":"cancelOrder","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"deployer","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"orderId","type":"string"}],"name":"getOrderInfo_Status_Owner","outputs":[{"name":"fromAddress","type":"address"},{"name":"toAddress","type":"address"},{"name":"status","type":"string"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"orderId","type":"string"},{"name":"fromType","type":"string"},{"name":"toType","type":"string"},{"name":"fromId","type":"string"},{"name":"toId","type":"string"},{"name":"fromUnits","type":"int256"},{"name":"toUnits","type":"int256"},{"name":"fromUniqueIdentifier","type":"string"},{"name":"toUniqueIdentifier","type":"string"}],"name":"placeOrder","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"inputs":[],"payable":false,"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"uniqueIdentifier","type":"bytes32"},{"indexed":false,"name":"authorizedIssuer","type":"address"},{"indexed":false,"name":"reissuable","type":"bool"}],"name":"bulkAssetTypeCreated","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"units","type":"int256"},{"indexed":false,"name":"to","type":"address"}],"name":"bulkAssetsIssued","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"units","type":"int256"},{"indexed":false,"name":"from","type":"address"},{"indexed":false,"name":"to","type":"address"},{"indexed":false,"name":"fromBalance","type":"int256"},{"indexed":false,"name":"toBalance","type":"int256"}],"name":"bulkAssetsTransferred","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"uniqueIdentifier","type":"bytes32"},{"indexed":false,"name":"authorizedIssuer","type":"address"}],"name":"soloAssetTypeCreated","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"uniqueAssetIdentifier","type":"string"},{"indexed":false,"name":"to","type":"address"}],"name":"soloAssetIssued","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"uniqueAssetIdentifier","type":"string"},{"indexed":false,"name":"key","type":"string"},{"indexed":false,"name":"value","type":"string"}],"name":"addedOrUpdatedSoloAssetExtraData","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"uniqueAssetIdentifier","type":"string"},{"indexed":false,"name":"to","type":"address"},{"indexed":false,"name":"from","type":"address"}],"name":"transferredOwnershipOfSoloAsset","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"assetName","type":"string"},{"indexed":false,"name":"uniqueIdentifier","type":"string"}],"name":"closedSoloAsset","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"orderId","type":"string"}],"name":"orderPlaced","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"orderId","type":"string"}],"name":"orderFulfilled","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"orderId","type":"string"}],"name":"orderCancelled","type":"event"}]);
    }
