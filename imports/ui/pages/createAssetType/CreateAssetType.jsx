...
class CreateAssetType extends Component {
  ...
  createAssetType = (e, instanceId) => {
    ...
    Meteor.call(
      'createAssetType',
      instanceId,
      this[instanceId + '_createAssetType_assetName'].value,
      this[instanceId + '_createAssetType_assetType'].value,
      this[instanceId + '_createAssetType_assetIssuer'].value,
      reissuable,
      decimals,
      error => {
        if (!error) {
                            ...
                            <form role="form">
                              <div className="form-group">
                                ...
                                <input
                                  ...
                                  required
                                  ref={input => {
                                    this[this.props.network[0].instanceId + '_createAssetType_assetName'] = input;
                                  }}
                                />
                              </div>
                              <div className="form-group">
                                ...
                                <select
                                  className="form-control"
                                  onChange={e => {
                                    this.assetTypeSelectionChanged(this.props.network[0].instanceId, e);
                                  }}
                                  required
                                  ref={input => {
                                    this[this.props.network[0].instanceId + '_createAssetType_assetType'] = input;
                                  }}
                                >
                              ...
                              {this.state[this.props.network[0].instanceId + '_showReissuable'] && (
                                <div className="form-group">
                                  ...
                                  <select
                                    ...
                                    required
                                    ref={input => {
                                      this[this.props.network[0].instanceId + '_createAssetType_reissuable'] = input;
                                    }}
                                  >
                              ...
                              {this.state[this.props.network[0].instanceId + '_showDecimals'] && (
                                <div className="form-group">
                                  ...
                                  <input
                                    ...
                                    className="form-control"
                                    ref={input => {
                                      this[this.props.network[0].instanceId + '_createAssetType_decimals'] = input;
                                    }}
                                  />
                                </div>
                              )}
                              <div className="form-group">
                                ...
                                <select
                                  ...
                                  required
                                  ref={input => {
                                    this[this.props.network[0].instanceId + '_createAssetType_assetIssuer'] = input;
                                  }}
                                >
